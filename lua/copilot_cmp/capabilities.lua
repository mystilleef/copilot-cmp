...
local function deprecate(name, alternative, version, plugin, backtrace)
  ...
  message = alternative and (message .. ", use " .. alternative .. " instead.")
    or message
  message = message
    ...
    textDocument = {
      completion = {
        ...
        completionItem = {
          ...
          commitCharactersSupport = if_nil(
            override.commitCharactersSupport,
            true
          ),
...
M.update_capabilities = function(_, override)
  ...
  _deprecate(
    "copilot_cmp.update_capabilities",
    "copilot_cmp.default_capabilities",
    "1.0.0",
    "copilot_cmp"
  )
